...
The token deck looks to pair token creators with anthems in order to create overwhelming board states. This deck plays much like a white aggro deck during the early stages of the game then pivots into exploding with tokens (many of which will have flying) to finish off unsuspecting opponents. Using green, you get [Trostani Discordant](https://mikeymischief.github.io/images/mtg/grn-208-trostani-discordant.jpg), and red has even more token creators with Hanweir Garrison and [Goblin Rabblemaster](https://mikeymischief.github.io/images/mtg/m15-145-goblin-rabblemaster.jpg). Don't forget there is a perfect signpost card in Boros with Heroic Reinforcements.
...
A classic deck from back in the power-max cube days. This archetype has still survived and is poised to still be a threat. What this deck does is try to accelerate mana production by using numerous manarocks ([Mind Stone](https://mikeymischief.github.io/images/mtg/wth-153-mind-stone.jpg), Guardian Idol), droping a 5+ toughness creature, preferably something like [Primeval Titan](https://mikeymischief.github.io/images/mtg/tsr-365-primeval-titan.jpg), and then playing a [Wildfire](https://mikeymischief.github.io/images/mtg/usg-228-wildfire.jpg) or [Burning of Xinye](https://mikeymischief.github.io/images/mtg/ptk-104-burning-of-xinye.jpg) the following turn. Pairing this with blue, gets you card filtering to find [Wildfire](https://mikeymischief.github.io/images/mtg/usg-228-wildfire.jpg) faster, pairing with green get you recursive lands and many large fatties. Wildfile works with any of the other colors and is one of the premier big red decks in the format.
...
Human Tribal aggro is viable and fast aggro deck, and one of the newer enabled archetypes by lowering the power level. Within this deck, you are planning on using white and black disruption to keep opponents off-kilter while your aggressive creatures finish them off. White gets many taxing effects ([Thalia, Guardian of Thraben](https://mikeymischief.github.io/images/mtg/dka-24-thalia-guardian-of-thraben.jpg), Vryn Wingmare) and black gets to attack the opponent's hand with cards like Thoughtseize and Duress. Corpse Knight is a great way to keep the pressure on while playing to the board. Be careful, sweepers will ruin the day of any aggro drafter, but there are many ways to recover post-sweeper in black and white: Luminous Broodmoth, Xathrid Necromancer or even Selfless Spirit.
...
There is plenty of support for the UG Self-Mill deck and just as many payoffs. You can take this deck to the extreme with the [Laboratory Maniac](https://mikeymischief.github.io/images/mtg/uma-61-laboratory-maniac.jpg), [Jace, Wielder of Mysteries](https://mikeymischief.github.io/images/mtg/war-54-jace-wielder-of-mysteries.jpg), and [Thassa's Oracle](https://mikeymischief.github.io/images/mtg/thb-308-thassa-s-oracle.jpg) "combo" route. You can build a top-end beatdown deck with cards like [Golgari Grave-Troll](https://mikeymischief.github.io/images/mtg/uma-167-golgari-grave-troll.jpg), a creature that can come back to play if you accidentally mill it, or with Body Double, a card that feels like a tutor for the best creature in your graveyard. Additionally, there is _Embalm_ on Vizier of Many Faces. This deck is only restricted by your creativity. With multiple looters in blue and filtering in green, this archetype is definitely one to watch.
...
Another classic archtype deck, Green and Black Graveyard recursion. The idea is to try and reuse creatures from an endless graveyard. You can go for a combo deck and try running reanimator with [Dread Return](https://mikeymischief.github.io/images/mtg/tsp-104-dread-return.jpg) or Vicitmize, paired with any of the green or black fatties. For kicks, you can power up this archetype by drafting the large bombs: [Living Death](https://mikeymischief.github.io/images/mtg/tmp-142-living-death.jpg) or Twilight's Call and get all your creatures in the graveyard. You can just build a value version which just reuses creature over and over from cards like Phyrexian Reclamation. Experienced drafters already know to employ this strategy along with creatures that have enter-the-battlefield abilities!
...
One of my favorite archetypes, Grixis Control is drafted by trying to control the board with spells that trade one-for-one and then using blue to draw cards to out card advantage your opponent. Bonus points for reusing those spells once they're cast with things like [Snapcaster Mage](https://mikeymischief.github.io/images/mtg/isd-78-snapcaster-mage.jpg), _Flashback_, Bond of Insight. Blue and Red have a spells-matters theme that fits perfectly with what this deck wants to accomplish. Red is versatile because the burn can be used to kill creatures to pave the way for your tiny creatures to attack or go straight to the face. Grixis is all about versatility and this deck does not disappoint.
...
Another new archetype that can shine since the removal of the power-oppressive cards. The lands deck was always just a bit underpowered with the previous environment, but here it gets a chance to shine. This deck looks to abuse lands in play and put those in the graveyard. Then, recur those lands with [Crucible of Worlds](https://mikeymischief.github.io/images/mtg/5dn-114-crucible-of-worlds.jpg). Many times those lands in hand will go straight to the face through Molten Vortex, or Borborygmos. Create a draw-engine with [The Gitrog Monster](https://mikeymischief.github.io/images/mtg/soi-245-the-gitrog-monster.jpg), build a large [Knight of the Reliquary](https://mikeymischief.github.io/images/mtg/tsr-379-knight-of-the-reliquary.jpg) or rest assured that you have inevitability by bringing Multani back over and over.
